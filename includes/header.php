        ...
        <div class="col-sm-9 col-md-10">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <a href="mailto:info@example.com">sirental@gmail.com</a> </div>
            <div class="header_widgets">
              <div class="circle_icon"> <i class="fa fa-phone" aria-hidden="true"></i> </div>
              <p class="uppercase_text">For Services Call Us: </p>
              <a href="tel:61-1234-5678-99">0888-8888-8888</a> </div>
...
while($results = mysqli_fetch_array($query))
	{
	 ...
	 <i class="fa fa-angle-down" aria-hidden="true"></i></a>
      ...
      <div class="collapse navbar-collapse" id="navigation">
          <a class="navbar-brand" href="index.php" style="margin-bottom: 20px; margin-right: 50px;">
            <img src="assets/images/Group 9.svg" alt="image" class="logo" style="max-width: 150px; height: auto; display: block;"/>
          </a>
